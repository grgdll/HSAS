function tmp = rd_oceanlogger_FICE(fn)
% FICE version of function to read surface data (xlsx files)
% Other metadata fields are available in xls meteo file.
    ...
    d.wdir = data(:,3) ; # azimuth from N [degrees] - median in previous 10 min
